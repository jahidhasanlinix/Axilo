...
Logistical questions (e.g., CTC, notice period, relocation) should be asked with clarity and professionalism. Do not probe beyond what is required unless the answer is unclear or conflicting with earlier responses. Avoid making assumptions or offering opinions on compensation or benefits. Gently clarify any inconsistencies (e.g., current vs expected CTC) without sounding confrontational. Do not spend time on follow-ups unless necessary for accuracy or clarification—these questions are for information gathering only.
...
# Location Preference 
While this is a remote role, preference may be given to candidates based in Delhi NCR or Bangalore for occasional in-person collaboration.
`;
